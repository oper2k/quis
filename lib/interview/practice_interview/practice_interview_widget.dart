                  ...
                  children: [
                    Align(
                      ...
                      child: InkWell(
                        ...
                        onTap: () async {
                          context.pushNamed('InterviewFeedback');
                        },
                        child: Lottie.asset(
                                          ...
                                          Padding(
                                            padding:
                                                EdgeInsetsDirectional.fromSTEB(
                                                    0.0, 2.0, 0.0, 0.0),
                                            child: Text(
                                              'Visit this page 5 minutes before the interview start time. Select your interview type and click \"Get Matched\". Matching is happen based on the amount of Karma you have.',
                                              style:
                                          ...
                                          Padding(
                                            padding:
                                                EdgeInsetsDirectional.fromSTEB(
                                                    0.0, 2.0, 0.0, 0.0),
                                            child: Text(
                                              'Join your interview over live video chat and take turns interviewing each other',
                                              style:
                                                  FlutterFlowTheme.of(context)
                                                      .headlineSmall
                                                      .override(
                                          ...
                                          Padding(
                                            padding:
                                                EdgeInsetsDirectional.fromSTEB(
                                                    0.0, 2.0, 0.0, 0.0),
                                            child: Text(
                                              'Match with Interview partner by swiping the screen at the end of Practice Interview. Once matched you are revealed with Social link for Networking.',
                                              style:
                                                  FlutterFlowTheme.of(context)
                                                      .headlineSmall
                                                      .override(
                    ...
                    StreamBuilder<List<FaqRecord>>(
                      ...
                      builder: (context, snapshot) {
                        ...
                        List<FaqRecord> containerFaqRecordList = snapshot.data!;
                        return Container(
                          decoration: BoxDecoration(),
                          child: Padding(
                            padding: EdgeInsetsDirectional.fromSTEB(

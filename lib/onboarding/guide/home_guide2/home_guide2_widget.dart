...
import 'home_guide2_model.dart';
export 'home_guide2_model.dart';

class HomeGuide2Widget extends StatefulWidget {
  const HomeGuide2Widget({super.key});

  @override
  State<HomeGuide2Widget> createState() => _HomeGuide2WidgetState();
}

class _HomeGuide2WidgetState extends State<HomeGuide2Widget>
    with TickerProviderStateMixin {
  late HomeGuide2Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => HomeGuide2Model());

    logFirebaseEvent('screen_view', parameters: {'screen_name': 'HomeGuide2'});
    // On page load action.
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      logFirebaseEvent('HOME_GUIDE2_HomeGuide2_ON_INIT_STATE');
      logFirebaseEvent('HomeGuide2_wait__delay');
                      ...
                      children: [
                        Expanded(
                          child: InkWell(
                            ...
                            onTap: () async {
                              logFirebaseEvent(
                                  'HOME_GUIDE2_PAGE_Row_p2dfxgx3_ON_TAP');
                        ...
                        Column(
                          ...
                          children: [
                            InkWell(
                              ...
                              onTap: () async {
                                logFirebaseEvent(
                                    'HOME_GUIDE2_Container_m4523u9s_ON_TAP');
                                ...
                                builder: (context) {
                                  if (revenue_cat.activeEntitlementIds
                                    ...
                                    return InkWell(
                                      ...
                                      onTap: () async {
                                        logFirebaseEvent(
                                            'HOME_GUIDE2_Container_4ezws808_ON_TAP');
                                        logFirebaseEvent(
                                    ...
                                    return InkWell(
                                      ...
                                      onTap: () async {
                                        logFirebaseEvent(
                                            'HOME_GUIDE2_Container_2j7kq7xh_ON_TAP');
                                        logFirebaseEvent(
                                            'Container_navigate_to');
                                        ...
                                        children: [
                                          Padding(
                                            ...
                                            child: InkWell(
                                              ...
                                              onTap: () async {
                                                logFirebaseEvent(
                                                    'HOME_GUIDE2_PAGE_Image_lblxhvm3_ON_TAP');
                                                logFirebaseEvent(
                                                    'Image_navigate_to');
                                          ...
                                          Padding(
                                            ...
                                            child: InkWell(
                                              ...
                                              onTap: () async {
                                                logFirebaseEvent(
                                                    'HOME_GUIDE2_PAGE_Image_e0zexvkr_ON_TAP');
                                                logFirebaseEvent(
                                                    'Image_launch_u_r_l');
                                                await launchURL(
                        ...
                        Container(
                          ...
                          child: Padding(
                            ...
                            child: InkWell(
                              ...
                              onTap: () async {
                                logFirebaseEvent(
                                    'HOME_GUIDE2_Container_aa69miij_ON_TAP');
                                logFirebaseEvent('Container_navigate_to');
                                        ...
                                        child: Container(
                                          ...
                                          child: Padding(
                                            ...
                                            child: InkWell(
                                              ...
                                              onTap: () async {
                                                logFirebaseEvent(
                                                    'HOME_GUIDE2_Container_shctvm1e_ON_TAP');
                                                logFirebaseEvent(
                                                    'Container_navigate_to');
                                          ...
                                          children: [
                                            Expanded(
                                              child: InkWell(
                                                ...
                                                onTap: () async {
                                                  logFirebaseEvent(
                                                      'HOME_GUIDE2_Container_m15lew0k_ON_TAP');
                                                  logFirebaseEvent(
                                                      'Container_navigate_to');
                                              ...
                                              child: StreamBuilder<
                                                ...
                                                builder: (context, snapshot) {
                                                  ...
                                                  return InkWell(
                                                    ...
                                                    onTap: () async {
                                                      logFirebaseEvent(
                                                          'HOME_GUIDE2_Container_hp5vaz3j_ON_TAP');
                                                      logFirebaseEvent(
                                                          'Container_navigate_to');
                                        ...
                                        child: StreamBuilder<CourseRecord>(
                                          ...
                                          builder: (context, snapshot) {
                                            ...
                                            return InkWell(
                                              ...
                                              onTap: () async {
                                                logFirebaseEvent(
                                                    'HOME_GUIDE2_PAGE_CourseRefItem_ON_TAP');
                                                logFirebaseEvent(
                                    ...
                                    child: Row(
                                      ...
                                      children: [
                                        ...
                                        InkWell(
                                          ...
                                          onTap: () async {
                                            logFirebaseEvent(
                                                'HOME_GUIDE2_Container_s2cyc75h_ON_TAP');
                                            logFirebaseEvent(
                                                'Container_navigate_to');
                                                ...
                                                builder: (context, snapshot) {
                                                  ...
                                                  return Container(
                                                    ...
                                                    child: InkWell(
                                                      ...
                                                      onTap: () async {
                                                        logFirebaseEvent(
                                                            'HOME_GUIDE2_Container_yy1akgie_ON_TAP');
                                                        logFirebaseEvent(
                                                            'Container_navigate_to');
                                              ...
                                              child: Stack(
                                                children: [
                                                  InkWell(
                                                    ...
                                                    onTap: () async {
                                                      logFirebaseEvent(
                                                          'HOME_GUIDE2_PAGE_Image_f6zdmjye_ON_TAP');
                                                      logFirebaseEvent(
                                                          'Image_navigate_to');
                                                  ...
                                                  if (!revenue_cat
                                                    ...
                                                    InkWell(
                                                      ...
                                                      onTap: () async {
                                                        logFirebaseEvent(
                                                            'HOME_GUIDE2_Container_4knyh9th_ON_TAP');
                                                        logFirebaseEvent(
                                                            'Container_navigate_to');
                                  ...
                                  child: Row(
                                    ...
                                    children: [
                                      InkWell(
                                        ...
                                        onTap: () async {
                                          logFirebaseEvent(
                                              'HOME_GUIDE2_PAGE_Container_ON_TAP');
                                          logFirebaseEvent(
                                              'Container_navigate_to');
                                ...
                                children: [
                                  ...
                                  Padding(
                                    ...
                                    child: FFButtonWidget(
                                      onPressed: () async {
                                        logFirebaseEvent(
                                            'HOME_GUIDE2_VIEW_PROFILES_BTN_ON_TAP');
                                        if (revenue_cat.activeEntitlementIds
                                            .contains(

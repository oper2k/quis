...
class _DeleteUserInfoDialogWidgetState
    extends State<DeleteUserInfoDialogWidget> {
  late DeleteUserInfoDialogModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => DeleteUserInfoDialogModel());
  }
